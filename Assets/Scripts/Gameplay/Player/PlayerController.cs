...
public class PlayerController : MonoBehaviour
{
    ...
    private void Rotate()
    {
        ...
        if (inputDir != Vector2.zero)
        {
            ...
            Vector3 tiltVector = Vector3.forward * Mathf.SmoothDampAngle(transform.eulerAngles.z, -zOffset * 1.2f, ref tiltSmoothVelocity, GetModifiedSmoothTime(tiltSmoothTime));
